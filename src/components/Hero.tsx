    ...
    <section className="flex flex-col md:p-8 px-8 md:px-0">
      <div className="relative md:my-10 my-7">
        ...
        <div className="container mx-auto md:px-7 flex justify-between items-start">
          <h1 className="text-gray-50 font-light md:text-6xl text-4xl">
            GALLERY
          </h1>
      ...
      <div className="flex flex-wrap md:grid md:grid-cols-4 md:gap-8 gap-4 container mx-auto md:px-7">
        <div className="md:col-span-1 flex flex-col md:gap-8 gap-4 overflow-hidden">
          <img className="w-full object-cover" src={lion} alt="lion" />
          <img
            className="w-full object-cover object-[80%__center]"
            src={flamingos}
            alt="flamingos"
          />
        </div>
        <div className="col-span-2 overflow-hidden">
          <img
            className="w-full md:h-4/5 h-full object-cover aspect-[16/11] object-[10%__center] "
            src={elephant}
            alt="elephant"
          />
        </div>
        <div className="col-span-1 overflow-hidden">
          <img
            className="w-full md:h-4/5 h-3/4 object-cover aspect-[9/16] object-[70%__center] "
            src={giraffes}
            alt="giraffes"
          />
          <button className="bg-[#F6B600] md:hidden  hover:bg-yellow-400 transition-colors duration-300 w-full text-[#151515] py-3.5 px-8 self-start font-light cursor-pointer mt-8">
            Discover Our Gallery
          </button>
        </div>
      </div>
